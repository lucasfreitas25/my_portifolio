...
const resources = {
  en: {
    translation: {
      ...
      showUnimed: "I performed requirements analysis with stakeholders, prototyped the indicator dashboard, handled data manipulation and processing, and finally built the dashboard using Power BI and Python.",
      showSeduc: "I work on API development, report construction, BI dashboard building, system integrations, and ETL processes. I use Python and Power BI as my main tools. I work on projects such as Pé de Meia, Mais Inglês, among others.",
      cursos: "Courses",
      curso: "Course",
      ...
      frontend: "FRONTEND",
      bd: "DB",
      engDados: "Data Engineer",
      analistaSistemas: "Jr Systems Analyst",
      engComputacao: "Senior Computer Engineer",
      unimedTitle: "Unimed",
      seducTitle: "Secretaria de Estado de Educação do Mato Grosso",
      niesaTitle: "Projeto Niesa UFMT",
      meiTitle: "Freitulitos",
      sedecTitle: "Secretaria de Desenvolvimento Econômico do Mato Grosso",
  ...
  pt: {
    translation: {
      ...
      showUnimed: "Realizei análise dos requisitos junto às partes interessadas, prototipação do painel de indicadores, manipulação e tratamento de dados, e por fim a construção do painel utilizando Power BI e Python.",
      showSeduc: "Atuo na construção de APIs, construção de relatórios, construção de painéis de BI, integrações de sistemas e processos de ETL. Utilizo Python e Power BI como principais ferramentas. Trabalho com projetos como Pé de Meia, Mais Inglês, entre outros.",
      cursos: "Cursos",
      curso: "Curso",
      ...
      analistaSistemas: "Analista de Sistemas JR",
      engComputacao: "Engenheiro da Computação Sênior",
      unimedTitle: "Unimed",
      seducTitle: "Secretaria de Estado de Educação do Mato Grosso",
      niesaTitle: "Projeto Niesa UFMT",
      meiTitle: "Freitulitos",
